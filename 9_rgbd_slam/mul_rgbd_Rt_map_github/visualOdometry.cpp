...
int main( int argc, char** argv){
    ...
    FRAME lastFrame;
    stringstream ss;
    ss<< "/media/q/q/rgbd-slam-tutorial/mul_rgbd_Rt_map/rgb_png/" <<currIndex<< ".png";
    string filename;
    ss>>filename;
    ...
    ss.clear();
    filename.clear();
    ss<<"/media/q/q/rgbd-slam-tutorial/mul_rgbd_Rt_map/depth_png/"<<currIndex<< ".png";
    ss>>filename;
    ...
    for (currIndex = startIndex + 1; currIndex<endIndex; currIndex++ ){
        ...
        cout<<"T\n"<<T.matrix()<<endl;
//        0.999965     -0.00453291  0.00697546  -0.00379518
//        0.00452789    0.999989    0.000735529  0.00646986
//       -0.00697872   -0.00070392  0.999975     0.000639527
//        0             0           0            1
