...
{ 
    ...
    while (ros::ok()){
		...
		cv::Mat rgb, depth;
		rgb = cv::imread( "/media/q/Q/vo/catkin_ws/src/pub_sub_pcl_topic_pkg/image/rgb.png" );
		depth = cv::imread( "/media/q/Q/vo/catkin_ws/src/pub_sub_pcl_topic_pkg/image/depth.png", -1 );
