...
void showCloudstmp(const pcl::PointCloud<pcl::PointXYZRGB>::Ptr cloud_source)
{
	...
	viewer->addPointCloud<pcl::PointXYZRGB>(cloud_source, "sample cloud");
...
int main (int argc, char** argv)
{
	...
	{
		pcl::io::loadPCDFile ("/home/q/xiaoqiuslamshizhanjiaocheng/pcl_stu/data/tutorials/table_scene_lms400.pcd", *back_cloud);
		...
		*cloud_filtered=*back_cloud;
		...
		if(voxel_filter==true)
		{
			...
			*cloud_filtered=*cloud_filtered1;
			...
			std::cout << cloud_filtered->size()<< endl;
			showCloudstmp(cloud_filtered);
		}
