...
// global variables
string first_file = "/home/q/CLionProjects/slambook2/ch7/1.png";
string second_file = "/home/q/CLionProjects/slambook2/ch7/2.png";
...
void ComputeORB(const cv::Mat &img, vector<cv::KeyPoint> &keypoints, vector<DescType> &descriptors) {
  ...
  for (auto &kp: keypoints) {
    ...
    // 这段代码是为了求图像块的矩，通过矩找到图像的质心，通过图像的中心和质心得到方向向量，从而得到特征点的方向。
    float m01 = 0, m10 = 0;
    for (int dx = -half_patch_size; dx < half_patch_size; ++dx) {
      for (int dy = -half_patch_size; dy < half_patch_size; ++dy) {
        // cout << kp.pt.y << kp.pt.x << endl;
