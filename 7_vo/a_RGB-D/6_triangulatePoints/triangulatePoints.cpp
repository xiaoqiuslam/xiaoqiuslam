...
int main ( int argc, char** argv )
{
    ...
    for ( int i=0; i<matches.size(); i++ )
    {
        ...
        cout<<"point pixel2cam first frame: "<<pt1_cam<<endl;
        cout<<"point projected from 3D first frame:"<<pt1_cam_3d<<", d="<<points[i].z<<endl;
        
        Point2f pt2_cam = pixel2cam( keypoints_2[ matches[i].trainIdx ].pt, K );
        cout<<"point pixel2cam second frame: "<<pt2_cam<<endl;

        Mat pt2_trans = R*( Mat_<double>(3,1) << points[i].x, points[i].y, points[i].z ) + t;
        pt2_trans /= pt2_trans.at<double>(2,0);

        cout<<"point reprojected from 3D second frame: "<<pt2_trans.t()<<endl;
        cout<<endl;
    }
